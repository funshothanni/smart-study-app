...
public class AppDatabase {
    ...
    public void removeAssessment(int assessmentId) throws AssessmentNotFoundException {
        if (!allAssessments.containsKey(assessmentId)) {
            throw new AssessmentNotFoundException();
        }

        allAssessments.remove(assessmentId);
        checkAppDatabase();
    }
}
